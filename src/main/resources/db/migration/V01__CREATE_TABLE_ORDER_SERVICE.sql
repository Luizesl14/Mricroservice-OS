...
$$
    BEGIN IF NOT EXISTS(SELECT 1
                        ...
                        WHERE CONSTRAINT_NAME = 'fk_tb_order_service_box_body_id') THEN
        ALTER TABLE tb_order_service
            ADD CONSTRAINT FK_TB_ORDER_SERVICE_BOX_BODY_ID FOREIGN KEY (BOX_BODY_ID)
...
$$
    BEGIN IF NOT EXISTS(SELECT 1
                        FROM INFORMATION_SCHEMA.CONSTRAINT_COLUMN_USAGE
                        WHERE CONSTRAINT_NAME = 'fk_tb_order_service_payment_id') THEN
        ALTER TABLE TB_ORDER_SERVICE
            ADD CONSTRAINT FK_TB_ORDER_SERVICE_PAYMENT_ID FOREIGN KEY (PAYMENT_ID)
...
$$
    BEGIN IF NOT EXISTS(SELECT 1
                        FROM INFORMATION_SCHEMA.CONSTRAINT_COLUMN_USAGE
                        WHERE CONSTRAINT_NAME = 'fk_tb_order_service_order_status_id') THEN
        ALTER TABLE TB_ORDER_SERVICE
            ADD CONSTRAINT FK_TB_ORDER_SERVICE_ORDER_STATUS_ID FOREIGN KEY (ORDER_STATUS_ID)
