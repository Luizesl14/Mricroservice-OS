package com.systemorderservice.insfrastructure.http.handler;

import com.systemorderservice.insfrastructure.http.ErrorMapResponse;
import com.systemorderservice.insfrastructure.http.ErrorResponse;
...
public class ResourceHandler {
    ...
    public ResponseEntity<ErrorResponse> handlerException(OrderServiceException m) {
