package com.systemorderproducer.insfrastructure.http.handler;

import com.systemorderproducer.insfrastructure.http.ErrorMapResponse;
import com.systemorderproducer.insfrastructure.http.ErrorResponse;
...
public class ResourceHandler {
    ...
    @ExceptionHandler(OrderProducerException.class)
    public ResponseEntity<ErrorResponse> handlerException(OrderProducerException m) {
